...
<body style=" background: #423f3f; margin-top: 80px">
    ...
    <main class="###" style="width: 1440px; height: 1573px; position: relative; overflow: auto;">
        ...
        <section>
            ...
            <img id="background-image" src="images/leg.jpg"/>
            
              <p style="position: absolute; left: 478px; top: 134px; font-size: 128px; font-weight: 700; text-align: center; color: #fff;">
                 <span style="font-size: 128px; font-weight: 700; text-align: center; color: #fff;">Leg <br> Workout </span>
                </p>
        ...
        <section>
            ...
            <div id="embedded-video">
                <iframe width="705" height="429" src="https://www.youtube.com/embed/H6mRkx1x77k" title="The Ultimate Science-Based Leg Day For Muscle Growth (2023)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        ...
        <section>
            ...
            <p id="text-beside-video">
                What are the best and worse Leg exercises for muscle growth?
            </p>
