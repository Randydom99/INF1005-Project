...
<body>
    ...
    <section style=" background: url(../images/workout.jpg) no-repeat;
                 min-height: 100vh;
    display: flex;
    align-items: center;
...
" class="workout" id="workout">
    ...
    <section class="video-section" id="video-section">
        ...
        <div class="row">
            ...
            <div class="video">
            <iframe src="https://www.youtube.com/embed/RDWyqnGhmWY" title="The Best Workout Split for MAXIMUM Muscle Gains" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>    
            </div>
