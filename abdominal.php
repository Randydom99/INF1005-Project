...
<body style="text-align: center; background: #423f3f;">
  ...
  <div id="embedded-video">
    <iframe width="705" height="429" src="https://www.youtube.com/embed/_xdOuqokcm4" title="How To Get Six Pack Abs | Ab Training Science Explained ft. Christian Guzman" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>
  
  <p style="position: absolute; left: 478px; top: 134px; font-size: 128px; font-weight: 700; text-align: center; color: #fff;">
      <span style="font-size: 128px; font-weight: 700; text-align: center; color: #fff;">Abdominal<br> Workout </span>
  </p>
  ...
  <p id="text-beside-video">
        What are the best and worse Abdominal exercises for muscle growth?
  </p>
...
<body style="text-align: center; background: #423f3f;">
    ...
    <main class="###" style="width: 1440px; height: 1573px; position: relative; overflow: auto;">
        ...
        <section>
            ...
            <img id="background-image" src="images/abs.jpg"/>
        ...
        <section>
            ...
            <div id="embedded-video">
                <iframe width="709" height="429" src="https://www.youtube.com/embed/1G0y8D5rFDc" title="How To Build A Better Core &amp; Six Pack Abs: Optimal Training Explained" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
