...
<body style=" background: #423f3f; margin-top: 80px">
    ...
    <main class="###" style="width: 1440px; height: 1573px; position: relative; overflow: auto;">
        ...
        <section>
            ...
            <img id="background-image" src="images/chest-image-1.jpeg"/>
            
              <p style="position: absolute; left: 478px; top: 134px; font-size: 128px; font-weight: 700; text-align: center; color: #fff;">
                 <span style="font-size: 128px; font-weight: 700; text-align: center; color: #fff;">Chest <br> Workout </span>
                </p>
        ...
        <section>
            ...
            <div id="embedded-video">
                <iframe width="705" height="429" src="https://www.youtube.com/embed/NsEbXsTwas8" title="The Best &amp; Worst Chest Exercises To Build Muscle (Ranked!)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>    
            </div>
